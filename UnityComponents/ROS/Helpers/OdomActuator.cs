...
{
    public class OdomActuator : Actuator
    {
        [Tooltip("The reference space in which the odometry will be applied (local or global).")]
        ...
        /// <summary>
        /// Actuates the Odometry application based on the provided data.
        /// </summary>
        /// <param name="odom"></param>
        public void ActuateOdom(Odometry odom)
        {
            this.odom = odom;
        }
